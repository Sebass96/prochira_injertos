...
rdt %>% 
  plot_raw(x = "year", y = "n_fruits")

anova(model_3)

mc_3 <- agricolae::duncan.test(model_3, trt = c("treat")) %>% 
  pluck("groups") %>% 
  rownames_to_column("treat")
...
mc_3 <- agricolae::duncan.test(model_3, trt = c("year")) %>% 
  pluck("groups") %>% 
...
rdt %>% 
  plot_raw(x = "treat", y = "flowering")

rdt %>% 
  plot_raw(x = "year", y = "flowering")

anova(model_4)

mc_4 <- agricolae::duncan.test(model_4, trt = c("treat")) %>% 
  pluck("groups") %>% 
  rownames_to_column("treat")
...
mc_4 <- agricolae::duncan.test(model_4, trt = c("year")) %>% 
  pluck("groups") %>% 
  rownames_to_column("year")
